...
class Model(base):
    ...
    kcal         = pw.IntegerField(null=True)                                   # 열량(kcal) - 1~2세 일일 총 열량
    protein      = pw.FloatField(null=True)                                     # 단백질(g) - 1~2세
    kcal_35      = pw.IntegerField(null=True)                                   # 열량(kcal) - 3~5세 일일 총 열량
    protein_35   = pw.FloatField(null=True)                                     # 단백질(g) - 3~5세
